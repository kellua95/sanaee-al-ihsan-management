        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookNumber = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_FinancialEntry_Amount", "\"Amount\" > 0");
                    table.ForeignKey(
                        name: "FK_FinancialEntries_Sponsors_SponsorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonthlyAmount = table.Column<decimal>(type: "numeric(18,3)", precision: 18, scale: 3, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Sponsorship_Dates", "\"EndDate\" >= \"StartDate\"");
                    table.CheckConstraint("CK_Sponsorship_MonthlyAmount", "\"MonthlyAmount\" > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    FinancialEntryId = table.Column<int>(type: "integer", nullable: false),
                    ...
                    AddedMonths = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PaymentAllocation_Amount", "\"AllocatedAmount\" > 0");
                    table.CheckConstraint("CK_PaymentAllocation_Dates", "\"NewEndDate\" > \"PreviousEndDate\"");
                    table.CheckConstraint("CK_PaymentAllocation_Months", "\"AddedMonths\" > 0");
                    table.ForeignKey(
                        name: "FK_PaymentAllocations_FinancialEntries_FinancialEntryId",
                        column: x => x.FinancialEntryId,
                        principalTable: "FinancialEntries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PaymentAllocations_Sponsorships_SponsorshipId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Beneficiaries_FileNumber",
                table: "Beneficiaries",
                column: "FileNumber",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinancialEntries_DonorName",
                table: "FinancialEntries",
                column: "DonorName");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinancialEntries_EntryType",
                table: "FinancialEntries",
                column: "EntryType");

            migrationBuilder.CreateIndex(
                name: "IX_FinancialEntries_SponsorId",
                table: "FinancialEntries",
                column: "SponsorId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentAllocations_FinancialEntryId",
                table: "PaymentAllocations",
                column: "FinancialEntryId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentAllocations_FinancialEntryId_SponsorshipId",
                table: "PaymentAllocations",
                columns: new[] { "FinancialEntryId", "SponsorshipId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PaymentAllocations_SponsorshipId",
                table: "PaymentAllocations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sponsorships_SponsorId_Status",
                table: "Sponsorships",
